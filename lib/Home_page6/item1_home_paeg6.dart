...
class item1homepage6 extends StatelessWidget {
  const item1homepage6({Key key}) : super(key: key);
  @override
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                      child: AutoSizeText(
                        'พิเศษสำหรับสมาชิก Rolyal canin Club ใช้เพียง 5 คะเเนนเเลก ส่วนลด 50บาท เมือซื้ออาหารเม็ด Rolyal canin สูตรลูกหมา (Kitten) ขนาด 1กกใ ขึ้นไป',
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text(
                    'ใช้สิทธิ์ได้ตั้งเเต่วันที่ 16กพ. - 30เมฬย 64',
                    style: TextStyle(color: Colors.black, fontSize: 14),
                  )
                ],
              ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: AutoSizeText(
                      '*คูปองนี้สามารถใช้ได้ 1 สิทธิ์/คน/เดือน',
                      style: TextStyle(color: Colors.black, fontSize: 14),
                    ),
                  )
                ],
