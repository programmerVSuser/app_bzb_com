...
class regiterExxxx extends StatefulWidget {
  @override
  _regiterExxxxState createState() => _regiterExxxxState();
}

class _regiterExxxxState extends State<regiterExxxx> {
