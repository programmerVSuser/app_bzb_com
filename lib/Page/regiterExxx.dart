...
class regiterExxx extends StatefulWidget {
  @override
  _regiterExxxState createState() => _regiterExxxState();
}

class _regiterExxxState extends State<regiterExxx> {
